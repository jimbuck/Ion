...
public sealed class TextureFactory
{
	...
	/// </summary>
	public ITexture2D Create(string name, uint width, uint height, ReadOnlySpan<byte> rgba)
	{
		...
		var levels = Texture2DLoader.BuildMipChain(rgba.ToArray(), (int)width, (int)height);
