...
internal class InputState : IInputState
{
	...
	public bool Down(MouseButton btn) => false;// _inputSnapshot?.IsMouseDown((Veldrid.MouseButton)btn) ?? false;
	...
	{
		//_window._window?.SetMousePosition(position);
	}

	public void SetMousePosition(int x, int y)
	{
		//_window._window?.SetMousePosition(x, y);
	}
}
