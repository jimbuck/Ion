...
{
	public static IKyberApplication UseInit(this IKyberApplication app, Action<GameTime> middleware) => app.UseInit(next => dt => { middleware(dt); next(dt); });
	...
	public static IKyberApplication UseFirst(this IKyberApplication app, Action<GameTime> middleware) => app.UseFirst(next => dt => { middleware(dt); next(dt); });
	...
	public static IKyberApplication UseFixedUpdate(this IKyberApplication app, Action<GameTime> middleware) => app.UseFixedUpdate(next => dt => { middleware(dt); next(dt); });
	...
	public static IKyberApplication UseUpdate(this IKyberApplication app, Action<GameTime> middleware) => app.UseUpdate(next => dt => { middleware(dt); next(dt); });
	...
	public static IKyberApplication UseRender(this IKyberApplication app, Action<GameTime> middleware) => app.UseRender(next => dt => { middleware(dt); next(dt); });
	...
	public static IKyberApplication UseLast(this IKyberApplication app, Action<GameTime> middleware) => app.UseLast(next => dt => { middleware(dt); next(dt); });
	...
	public static IKyberApplication UseDestroy(this IKyberApplication app, Action<GameTime> middleware) => app.UseDestroy(next => dt => { middleware(dt); next(dt); });
