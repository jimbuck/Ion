...
public static class UseMiddlewareExtensions
{
	...
	public static KyberApplication UseUpdateMiddleware<[DynamicallyAccessedMembers(MiddlewareAccessibility)] TMiddleware>(this KyberApplication app, params object?[] args)
	{
	...
	/// <param name="args">The arguments to pass to the middleware type instance's constructor.</param>
	/// <returns>The <see cref="IApplicationBuilder"/> instance.</returns>
	public static KyberApplication UseUpdateMiddleware(
		this KyberApplication app,
	...
	{
		private readonly KyberApplication _app;
