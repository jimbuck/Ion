...
namespace Kyber.Assets.Processors;

internal class AssimpProcessor : BinaryAssetProcessor<ProcessedModel>
{
	...
	private ProcessedAnimationChannel ConvertChannel(NodeAnimationChannel nac)
	{
		...
		VectorKey[] positions = new VectorKey[nac.PositionKeyCount];
		...
		VectorKey[] scales = new VectorKey[nac.ScalingKeyCount];
		...
		QuaternionKey[] rotations = new QuaternionKey[nac.RotationKeyCount];
